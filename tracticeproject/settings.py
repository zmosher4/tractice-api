"""
Django settings for tractice project.
...
CORS_ALLOW_ALL_ORIGINS = True  # For testing. Once working, you can remove this and rely on CORS_ALLOWED_ORIGINS
...
ROOT_URLCONF = "tracticeproject.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [
            os.path.join(BASE_DIR, 'tracticeapi/templates'),
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "tracticeproject.wsgi.application"
...
# STATICFILES_DIRS = [
#     os.path.join(BASE_DIR, 'tracticeapi/static'),
# ]
